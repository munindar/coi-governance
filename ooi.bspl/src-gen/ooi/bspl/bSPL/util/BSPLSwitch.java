...
public class BSPLSwitch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case BSPLPackage.BSPL:
      {
        BSPL bspl = (BSPL)theEObject;
        T result = caseBSPL(bspl);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case BSPLPackage.ROLE:
      {
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>BSPL</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>BSPL</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseBSPL(BSPL object)
  {
    return null;
  }
